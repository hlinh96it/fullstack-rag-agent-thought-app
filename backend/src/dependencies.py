...
# from src.services.parser.parser import PDFParserService
...
# def get_document_parser_service(request: Request) -> PDFParserService:
...
# PDFParserDependency = Annotated[PDFParserService, Depends(get_document_parser_service)]
